...
void ABuildPiece_Z::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void ABuildPiece_Z::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

APiece* ABuildPiece_Z::getPiece()
{
	return piece;
}

void ABuildPiece_Z::spawnBlocks()
{
	const std::vector<std::pair<float, float>> shapes = { {-10.0, -10.0}, {0.0, -10.0}, {0.0, 0.0}, {10.0, 0.0} };
